...
setDecisionSelectOptions=function(id,values,selected=[],col='',allLabel='Alla'){
  ...
  sel.innerHTML=`<option value="" disabled selected>Välj fler...</option><option value="${decisionFilterClearValueFinal}">${esc(allLabel)}</option>${options}`;
  sel.value='';
};
