...
$('newTab').onclick=createCalculationFromTemplate;$('duplicateTab').onclick=duplicateCurrentCalculation;$('calcImportToggle').onclick=toggleCalculationImportMenu;$('calcImportSource').onchange=syncCalculationImportButton;$('calcImportApply').onclick=importCalculationMandates;if($('closeTab'))$('closeTab').onclick=()=>closeCalcTab(activeTab);
