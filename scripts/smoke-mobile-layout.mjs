...
try{
  ...
  const output={failures,calculatorScroll,searchableDropdownRect,decisionSwitchStability,decisionLayout,calendarRect,dialogRect,mobileFacetedFilters,zoomAudit,desktopWrapper,results};
