...
try{
  ...
  const result={mode:fileAudit?'file':'http',functionalFailures,calculatorTemplate,calculatorImport,calculator,calculatorIcon,rawProgressiveFilters,rawBackgroundLoad,rawSortReuse,rawPartyCanonical,rawPartyOrdering,inventory,functional,raw,decisionCold,decisionColdFilterResults,decisionMemberMarkers,decisionOverviewResume,calendar:{before:calendarBefore,monthAfter:calendarMonthAfter,yearAfter:calendarYearAfter},navigationDuringDecisionLoad,navigationDuringActivityLoad,decision,activity,additive,reloadExpected,reloadHashChanged:!!reloadHash,reload,postReload};
  console.log(JSON.stringify(filterResultsOnly?{calculatorTemplate,rawProgressiveFilters,rawBackgroundLoad,rawSortReuse,rawPartyCanonical,decisionColdFilterResults,decisionMemberMarkers,decisionOverviewResume}:result,null,2));
